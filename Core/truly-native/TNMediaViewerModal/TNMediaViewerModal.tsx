...
interface TNMediaViewerModalProps{
  mediaItems: [any],
  onClosed: ()=>void,
  isModalOpen: boolean,
...
export default class TNMediaViewerModal extends React.Component<TNMediaViewerModalProps,any> {
            ...
            this.props.mediaItems.map((item, index) => (
              <View
                ...
                <Image
                  ...
                  onLoad={evt =>{
                    const hgt = (evt.nativeEvent.height / evt.nativeEvent.width) *
                    width;
                    this.setState({
                      calcImgHeight: hgt
                    })
