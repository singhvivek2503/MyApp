...
import AlbumView,{ MemoizedAlbumView } from '../AlbumView/AlbumView';
import CameraView,{ MemoizedCameraView } from '../CameraView/CameraView';
...
export default function MediaComposer(props) {
  ...
  let media = useRef({});
  const didFocusSubscription:any = useRef({});
  ...
  const onBottomTabPress = index => {
    if (scrollRef.current) {
      scrollRef.current.scrollToOffset({ animated: true, offset: Math.floor(width * index) })
